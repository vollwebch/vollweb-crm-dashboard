...
async function main() {
  ...
  await prisma.trashConfig.deleteMany();
  ...
  console.log(`Usuarios creados: ${admin.name} (ADMIN), ${employee.name} (USER)`);
  ...
  await prisma.trashConfig.create({
    data: {
      autoDeleteDays: 10,
