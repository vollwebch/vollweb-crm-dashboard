...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, CheckCircle, Building2 } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        toast({ 
          title: '✓ Cuenta creada', 
          description: `Bienvenido ${data.user.name}. Tu empresa "${data.user.company.name}" ha sido registrada.` 
        })
      ...
      <Card className="w-full max-w-md relative border-0 shadow-2xl shadow-violet-200/50 bg-white/80 backdrop-blur-xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-slate-500">
            Registra tu empresa en Vollweb CRM
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="pt-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="companyName" className="text-slate-700 font-medium">Nombre de la Empresa *</Label>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="name"
                  type="text"
                  placeholder="Tu nombre (serás administrador)"
                  value={form.name}
